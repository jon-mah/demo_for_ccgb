...
#$ -cwd
#$ -V
#$ -N complete_downsample_14_05_05
...
python plot_likelihood.py ../Analysis/${species}_downsampled_14/empirical_syn_downsampled_sfs.txt 0.5 0.5 ../Analysis/${species}_downsampled_14/2
