...
#$ -cwd
#$ -V
#$ -N complete_downsample_14_1_5_01
...
python plot_likelihood.py ../Analysis/${species}_downsampled_14/empirical_syn_downsampled_sfs.txt 1.5 0.1 ../Analysis/${species}_downsampled_14/3
