...
singularity exec $H2_CONTAINER_LOC/MIDAS-mod.sif merge_midas.py genes $OUTDIR/genes -i ../Data/oral_microbiome_data/temp_midas_output -t dir --sample_depth 1 --min_samples 1
