...
# Gut with singletons
python plot_likelihood.py ../Analysis/${species}_downsampled_14/empirical_sfs.txt 1.0 0.5 ../Analysis/${species}_downsampled_14/likelihood_surface_unmasked/
