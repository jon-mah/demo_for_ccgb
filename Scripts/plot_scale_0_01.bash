...
# Gut with singletons
python plot_likelihood.py ../Analysis/${species}_downsampled_20/empirical_sfs.txt 1.0 0.01 ../Analysis/${species}_downsampled_20/likelihood_surface_unmasked/
