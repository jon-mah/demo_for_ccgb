...
#$ -cwd
#$ -V
#$ -N complete_downsample_14_2_150
...
python plot_likelihood.py ../Analysis/${species}_downsampled_14/empirical_syn_downsampled_sfs.txt 2.0 150.0 ../Analysis/${species}_downsampled_14/6
