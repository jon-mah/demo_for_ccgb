...
#$ -cwd
#$ -V
#$ -N complete_downsample_14_01_001
...
python plot_likelihood.py ../Analysis/${species}_downsampled_14/empirical_syn_downsampled_sfs.txt 0.1 0.01 ../Analysis/${species}_downsampled_14/6
