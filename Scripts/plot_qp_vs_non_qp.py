...
from utils import parse_midas_data, sample_utils, diversity_utils, stats_utils
from utils import sfs_utils, figure_utils
import matplotlib
matplotlib.use('Agg')
import pylab
import numpy
...
class PlotQpVsNonQp():
    ...
    def main(self):
        ...
        parser = self.PlotQpVsNonQpParser()
        ...
        haploid_axis.set_xlim([0, 500])
        haploid_axis.set_xticks([0, 100, 200, 300, 400, 500])
