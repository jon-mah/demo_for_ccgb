    ...
    def main(self):
        ...
        for model in model_list:
            if model == 'exponential_growth':
                ...
                lower_bound = [0, 0]
                initial_guesses = []
                initial_guesses.append([0.001, 0.00001])
                initial_guesses.append([0.01, 0.00001])
                initial_guesses.append([0.02, 0.00001])
                initial_guesses.append([0.03, 0.00001])
                initial_guesses.append([0.04, 0.00001])
                initial_guesses.append([0.05, 0.00001])
                initial_guesses.append([0.06, 0.00001])
                initial_guesses.append([0.07, 0.00001])
                initial_guesses.append([0.08, 0.00001])
                initial_guesses.append([0.09, 0.00001])
                ...
                initial_guesses.append([0.02, 0.02, 0.000001])
                initial_guesses.append([0.03, 0.03, 0.000001])
                initial_guesses.append([0.04, 0.04, 0.000001])
                initial_guesses.append([0.05, 0.05, 0.000001])
                initial_guesses.append([0.06, 0.06, 0.000001])
                initial_guesses.append([0.07, 0.07, 0.000001])
                initial_guesses.append([0.08, 0.08, 0.000001])
                initial_guesses.append([0.09, 0.09, 0.000001])
                ...
                initial_guesses.append([0.02, 0.02, 0.000001, 0.000001])
                initial_guesses.append([0.03, 0.03, 0.000001, 0.000001])
                initial_guesses.append([0.04, 0.04, 0.000001, 0.000001])
                initial_guesses.append([0.05, 0.05, 0.000001, 0.000001])
                initial_guesses.append([0.06, 0.06, 0.000001, 0.000001])
                initial_guesses.append([0.07, 0.07, 0.000001, 0.000001])
                initial_guesses.append([0.08, 0.08, 0.000001, 0.000001])
                initial_guesses.append([0.09, 0.09, 0.000001, 0.000001])
