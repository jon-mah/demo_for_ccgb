...
# Gut with singletons
python plot_likelihood.py ../Analysis/${species}_downsampled_14/empirical_sfs.txt 1.0 50.0 ../Analysis/${species}_downsampled_14/likelihood_surface_unmasked/
